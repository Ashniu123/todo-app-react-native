  ...
  constructor(props) {
    ...
    this.panResponder = PanResponder.create({
      ...
      onPanResponderMove: (e, gestureState) =>
        this.handlePanResponderMove.call(this, e, gestureState),
      onPanResponderRelease: (e, gestureState) =>
        this.handlePanResponderRelease.call(this, e, gestureState)
    });
      ...
      <View style={styles.container}>
        <Animated.View style={[this.state.position.getLayout()]} {...this.panResponder.panHandlers}>
          ...
          <View
            style={[
              styles.inner__view,
              { backgroundColor: this.props.completed ? '#eeeeee' : '#ffffff' }
            ]}
          >
            <Text style={styles.itemText}>{this.props.item}</Text>
            <TouchableWithoutFeedback hitSlop={{ top: 10, bottom: 10, right: 10, left: 10 }}>
              <Icon
